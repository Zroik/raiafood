        ...
        <ShopLayout>
            ...
            <div className="w-full max-w-[92vw] xl:max-w-[88vw] 2xl:max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-stretch">
                    {/* Form */}
                    <div style={{ backgroundColor: "#FCF3FF", borderRadius: SZ(15), padding: SZ(28) }} className="flex flex-col justify-between">
                        <div>
            ...
            <div className="w-full max-w-[92vw] xl:max-w-[88vw] 2xl:max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 pb-14 sm:pb-16">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
                    ...
                    <div style={{ backgroundColor: "#FAE6FF", borderRadius: SZ(15), padding: SZ(28), display: "flex", flexDirection: "column", gap: SZ(10) }}>
                        ...
                        <a href={companyMapsLink} target="_blank" rel="noreferrer" style={{ fontFamily: "Outfit, sans-serif", fontWeight: 400, fontSize: SZ(15), color: "#843799", display: "inline-flex", alignItems: "center", gap: SZ(4), marginTop: "auto" }}>
                    ...
                    <div style={{ backgroundColor: "#FAE6FF", borderRadius: SZ(15), padding: SZ(28), display: "flex", flexDirection: "column", gap: SZ(10) }}>
                        ...
                        <a href={`https://wa.me/${whatsappNum}`} target="_blank" rel="noreferrer" style={{ fontFamily: "Outfit, sans-serif", fontWeight: 400, fontSize: SZ(15), color: "#843799", display: "inline-flex", alignItems: "center", gap: SZ(4), marginTop: "auto" }}>
                    ...
                    <div style={{ backgroundColor: "#FAE6FF", borderRadius: SZ(15), padding: SZ(28), display: "flex", flexDirection: "column", gap: SZ(10) }}>
                        ...
                        <a href={`mailto:${companyEmail}`} style={{ fontFamily: "Outfit, sans-serif", fontWeight: 400, fontSize: SZ(15), color: "#843799", display: "inline-flex", alignItems: "center", gap: SZ(4), marginTop: "auto" }}>

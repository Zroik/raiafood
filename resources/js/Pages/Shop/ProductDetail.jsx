...
export default function ProductDetail({ product, relatedProducts, inWishlist }) {
    ...
    return (
        <ShopLayout>
            ...
            <div className="w-full max-w-[92vw] xl:max-w-[88vw] 2xl:max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-amber-50 border border-amber-200/60">
                                ...
                                <span className="text-gray-900 font-bold text-sm">{(Number(product.rating_avg) || 5.0).toFixed(1)}</span>
                            </div>
                            <span className="text-gray-300">|</span>
                            <span className="text-sm text-gray-500">{product.rating_count || 0} ulasan</span>
                            <span className="text-gray-300">|</span>
                            <span className="text-sm text-gray-700 font-medium">{product.total_sold ? (product.total_sold >= 1000 ? `${Math.floor(product.total_sold/1000)}RB+` : product.total_sold) : '0'} Terjual</span>
                        </div>

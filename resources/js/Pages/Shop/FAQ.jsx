    ...
    return (
        <div style={{
            ...
            <button onClick={onToggle} style={{
                ...
                gap: SZ(16), padding: `${SZ(20)} ${SZ(24)}`,
                background: "none", border: "none", cursor: "pointer", textAlign: "left",
            }}>
                {/* Icon circle */}
                <div style={{
                    flexShrink: 0, width: SZ(48), height: SZ(48), borderRadius: "50%",
                    ...
                    <svg fill="none" stroke="#843799" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"
                        style={{ width: SZ(22), height: SZ(22) }} viewBox="0 0 24 24">
                        <path d={item.iconPath} />
                    </svg>
                </div>
                {/* Title */}
                <span style={{ flex: 1, fontFamily: "Outfit, sans-serif", fontWeight: 700, fontSize: SZ(32), color: "#60396A", lineHeight: 1.2 }}>
                    {index + 1}. {item.title}
                </span>
                {/* Toggle +/- */}
                <div style={{
                    flexShrink: 0, width: SZ(32), height: SZ(32), borderRadius: "50%",
                    backgroundColor: isOpen ? "#843799" : "#F4C6FF",
                    display: "flex", alignItems: "center", justifyContent: "center",
                    transition: "background-color 0.2s",
                }}>
                    <svg fill="none" stroke={isOpen ? "#ffffff" : "#843799"} strokeWidth="2.5"
                        viewBox="0 0 24 24" style={{ width: SZ(14), height: SZ(14) }}>
                        {isOpen
            ...
            {/* Collapsible content */}
            {isOpen && (
                <div style={{ paddingLeft: `calc(${SZ(48)} + ${SZ(16)} + ${SZ(24)})`, paddingRight: SZ(24), paddingBottom: SZ(20) }}>
                    <p style={{ fontFamily: "Inter, sans-serif", fontWeight: 500, fontSize: SZ(20), color: "#60396A", lineHeight: 1.7, whiteSpace: "pre-line" }}>
                        {item.content}
                    </p>
                </div>
            )}
...
export default function FAQ() {
    ...
    return (
        <ShopLayout>
            ...
            <section style={{ width: "100%", backgroundColor: "transparent", paddingLeft: SZ(40), paddingRight: SZ(40), marginTop: "-100px", position: "relative", zIndex: 10 }}>
                <div style={{ backgroundColor: "#FCF3FF", borderRadius: SZ(15), padding: SZ(32) }}>
                    <div style={{ display: "flex", flexDirection: "column", gap: SZ(12) }}>
                        {faqData.map((item) => (
                            <FaqItem key={item.id} item={item} index={faqData.indexOf(item)} isOpen={openId === item.id} onToggle={() => toggle(item.id)} />
                        ))}
                    </div>
                </div>
            </section>
            ...
            <section style={{ width: "100%", backgroundColor: "#ffffff", paddingLeft: SZ(40), paddingRight: SZ(40) }}>
                <div style={{ position: "relative", width: "100%", overflow: "hidden", borderRadius: SZ(15) }}>
                    {/* Banner image */}
                    <img src="/images/masih-butuh-bantuan.webp" alt="Masih Butuh Bantuan" style={{ width: "100%", display: "block", objectFit: "cover" }} />

                    {/* Overlay content */}
                    <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "flex-start", paddingLeft: "25%", paddingRight: SZ(32), gap: SZ(45) }}>
                        {/* Text */}
                        <div style={{ transform: "translateX(SZ(10))" }}>
                        ...
                        {/* Buttons — 30% larger than before (which were SZ(21) font, SZ(14) padding) */}
                        <div style={{ flexShrink: 0, display: "flex", flexDirection: "column", gap: SZ(13) }}>
                            <a href="https://wa.me/6281222777468" target="_blank" rel="noreferrer"
                                style={{ display: "inline-flex", alignItems: "center", gap: SZ(13), paddingLeft: SZ(34), paddingRight: SZ(34), paddingTop: SZ(18), paddingBottom: SZ(18), borderRadius: SZ(13), backgroundColor: "#843799", textDecoration: "none", whiteSpace: "nowrap", transition: "opacity 0.2s" }}
                                onMouseEnter={e => e.currentTarget.style.opacity = "0.85"}
                                onMouseLeave={e => e.currentTarget.style.opacity = "1"}
                            >
                                <svg fill="#ffffff" viewBox="0 0 24 24" style={{ width: SZ(30), height: SZ(30), flexShrink: 0 }}>
                                ...
                                <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 600, fontSize: SZ(27), color: "#ffffff" }}>Chat WhatsApp</span>
                            </a>
                            <Link href="/hubungi-kami"
                                style={{ display: "inline-flex", alignItems: "center", gap: SZ(13), paddingLeft: SZ(34), paddingRight: SZ(34), paddingTop: SZ(18), paddingBottom: SZ(18), borderRadius: SZ(13), border: "1.5px solid #843799", backgroundColor: "rgba(255,255,255,0.75)", textDecoration: "none", whiteSpace: "nowrap", transition: "background-color 0.2s" }}
                            ...
                            >
                                <svg fill="none" stroke="#843799" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" style={{ width: SZ(30), height: SZ(30), flexShrink: 0 }}>
                                    <path d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                </svg>
                                <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 600, fontSize: SZ(27), color: "#843799" }}>Hubungi Kami</span>
                            </Link>
                        </div>
                    </div>
                </div>
